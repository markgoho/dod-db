...
featuredItems:
  - type: segment
    ...
    label: "What is That? — Atonement"
  - type: episode
    number: 22
    label: "Connecting with Source"
quotes:
  - text: "So, yeah, the idea of atonement is—is that bringing back together and repairing of—of that breach."
    speaker: "Dan McClellan"
    episode: 122
    timestamp: "00:03:44.150"
  - text: "And when it comes to atonement, this is a complex constellation of ideas. So what you really want is a way to take this and say, 'Think of it like this.' And so that is your atonement theory."
    speaker: "Dan McClellan"
    episode: 122
    timestamp: "00:11:40.010"
  - text: "And so the— a lot of the purification rites that are described in Leviticus and elsewhere are not about— have nothing to do with cleansing the people. It has to do with cleansing conceptually the sacred space, because we've done this thing and suddenly splurt there's a bunch of metaphysical contaminant on the wall of the temple, and we've got to do the stuff to scrub it off."
    speaker: "Dan McClellan"
    episode: 142
    timestamp: "00:53:58.928"
  - text: "That's where you get the ritual in Leviticus 16, the famous Day of Atonement ritual, where the priest has to sort of lay his hands on the head of that scapegoat and confess all of the sins of the Israelites over it and then banish that goat into the wilderness."
