...
quotes:
  - text: "And so it seems like the killing of Goliath is being attributed to some dude named Elhanan."
  ...
  - text: "This is textually interesting because Bethlehemite can, with just a few small tweaks, be changed to look like Lahmi, the brother of Goliath. And so likely the authors of Chronicles, who are writing centuries after whoever wrote this tradition as it's found in the book of 2 Samuel, are not comfortable with this idea since we already know who killed Goliath, and so they tweak the text just slightly in order to make it agree with the rest of the tradition."
    speaker: "Dan McClellan"
    episode: 6
    timestamp: "00:18:55.350"
  - text: "We have 151b where he says, 'I went out to attack the Philistine who cursed me by his idols, and I cut off his head, and so I removed the shame from the Israelites.' And so it looks like the Greek version is kind of folding the two together."
    speaker: "Dan McClellan"
    episode: 125
    timestamp: "00:37:40.016"
