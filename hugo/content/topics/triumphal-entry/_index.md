...
definition: "The triumphal entry is the gospel scene in which Jesus enters Jerusalem on a donkey or colt in deliberate dialogue with royal and prophetic imagery, especially Zechariah 9:9. In scholarship it is often discussed as a narratively charged, theologically shaped episode whose details differ across the gospels and reveal how each author frames Jesus’s kingship, mission, and relation to scripture."
featuredItems:
  - type: segment
    episodeNumber: 57
    segmentAnchor: opportunities-for-growth-1
    label: "Opportunities for Growth — Triumphal Entry"
  - type: episode
    number: 50
    label: "Easter and the Undead"
quotes:
  - text: "And that is the, the triumphal entry."
    speaker: "Dan McClellan"
    episode: 50
    timestamp: "00:05:26.240"
  - text: "In John chapter 12, he shows up in Bethany for his third trip to Jerusalem. And then he is anointed before the triumphal entry."
    speaker: "Dan McClellan"
    episode: 50
    timestamp: "00:10:04.670"
  - text: "The way the text is telling the story, Jesus is sitting on top of two animals."
    speaker: "Dan McClellan"
    episode: 57
    timestamp: "00:35:08.360"
  - text: "Matthew will tell the story so as to make it fulfill prophecy, even if it is ludicrous."
    speaker: "Dan McClellan"
    episode: 46
