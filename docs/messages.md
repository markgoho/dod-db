...
{/_ TODO: section on metadata types (response and usage) _/}
...
const messages = [new SystemMessage("You are a poetry expert"), new HumanMessage("Write a haiku about spring"), new AIMessage("Cherry blossoms bloom...")];
...
{/_ TODO: ensure these topics are covered somewhere _/}
