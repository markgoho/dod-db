...
export const tagVocabulary: TagDefinition[] = [
  ...
  },
  {
    ...
    episodes: [126, 146],
		...
		category: 'event',
		llmVerify: true,
		description: 'A Jewish holiday commemorating the saving of the Jews from Haman\'s plot to annihilate them, as recounted in the Book of Esther',
		status: 'accepted',
		addedInEpisode: 147,
		episodes: [3, 147],
	},
  ...
  },
  {
    ...
    episodes: [147],
		...
		category: 'literature',
		llmVerify: true,
		description: 'A 2nd-century CE apocryphal text recounting the story of Thecla\'s conversion and adventures with the apostle Paul.',
		status: 'accepted',
		addedInEpisode: 148,
		episodes: [33, 148],
	},	{
		...
		category: 'character',
		llmVerify: true,
		description: 'A companion of Paul mentioned in the New Testament, who later deserted him according to 2 Timothy.',
		status: 'accepted',
		addedInEpisode: 148,
		episodes: [100, 148],
	},	{
		...
		category: 'character',
		llmVerify: true,
		description: 'Mentioned in 2 Timothy 1:15, a figure who turned away from Paul\'s teachings.',
		status: 'accepted',
		addedInEpisode: 148,
		episodes: [148],
	},
  ...
  },
  {
    ...
    addedInEpisode: 149,
		...
		category: 'character',
		llmVerify: true,
		description: 'A deacon in the early church in Jerusalem who was stoned to death for his faith, as recorded in the Book of Acts.',
		status: 'accepted',
		addedInEpisode: 149,
