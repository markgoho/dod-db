...
export const tagVocabulary: TagDefinition[] = [
  ...
  { canonical: 'Isaiah', variations: [], category: 'character', llmVerify: true, description: 'the prophet Isaiah from the book of Isaiah, not references to the text of the book', status: 'accepted' },
	...
	{ canonical: '1 Samuel', variations: ['First Samuel'], category: 'literature', llmVerify: true, description: 'First Book of Samuel in the Hebrew Bible, narrates the reigns of Samuel, Saul, and David', status: 'accepted' },
	{ canonical: '2 Samuel', variations: ['Second Samuel', '2nd Samuel'], category: 'literature', llmVerify: true, description: 'Book of Samuel in the Hebrew Bible, continues the narrative of David\'s reign', status: 'accepted' },
	...
	{ canonical: '1 Chronicles', variations: ['First Chronicles', '1st Chronicles'], category: 'literature', llmVerify: true, description: 'book of 1st Chronicles present a retelling of the history of ancient Israel.', status: 'accepted' },
	{ canonical: 'Ephesians', variations: ['Book of Ephesians'], category: 'literature', llmVerify: true, description: 'Epistle in the New Testament, traditionally attributed to Paul but authorship debated', status: 'accepted' },
	...
	{ canonical: '2 Kings', variations: ['second kings', '2nd Kings'], category: 'literature', llmVerify: true, description: 'A book in the Hebrew Bible\'s historical narrative, continuing the account of the kingdoms of Israel and Judah', status: 'accepted' },
	...
	{ canonical: 'Book of Amos', variations: ['Amos'], category: 'literature', llmVerify: true, description: 'A book in the Hebrew Bible containing the prophecies of the prophet Amos.', status: 'accepted' },
	...
	{ canonical: '2 Chronicles', variations: ['Second Chronicles', '2nd chronicles'], category: 'literature', status: 'accepted' },
	...
	{ canonical: 'psalm 82', variations: ['psalms 82'], category: 'literature', description: 'Psalm discussing a divine council and judgment, often debated for its dating and theological implications', status: 'proposed', addedInEpisode: 57 },
	{ canonical: 'earth', variations: ['flat earth'], category: 'place', description: 'The planet we live on, conceptualized differently in ancient times compared to modern understanding', status: 'proposed', addedInEpisode: 57 },
	{ canonical: 'genesis 1', variations: ['genesis'], category: 'literature', description: 'First chapter of Genesis, describing the creation of the world in six days', status: 'proposed', addedInEpisode: 57 },
	{ canonical: 'job 26', variations: ['job'], category: 'literature', description: 'A passage in the Book of Job describing God\'s power and wisdom in creation.', status: 'proposed', addedInEpisode: 57 },
	...
	{ canonical: 'exodus 22', variations: ['exodus 22:8'], category: 'literature', description: 'Refers to chapter 22 of the Book of Exodus', status: 'proposed', addedInEpisode: 58 },
	...
	{ canonical: 'deuteronomy 32', variations: ['deuteronomy 32:8', 'deuteronomy 32:43'], category: 'literature', description: 'Refers to chapter 32 of the Book of Deuteronomy', status: 'proposed', addedInEpisode: 58 },
	...
	{ canonical: 'genesis 2', variations: ['genesis 2:8'], category: 'literature', description: 'Refers to chapter 2 of the Book of Genesis', status: 'proposed', addedInEpisode: 58 },
	...
	{ canonical: 'textual', variations: [], category: 'scholarship', description: 'Related to textual criticism, the study of comparing and analyzing different versions of texts', status: 'proposed', addedInEpisode: 60 },
	...
	{ canonical: 'gil hicks-keaton', variations: ['jill hicks-keaton'], category: 'person', description: 'Author of "The Good Book," which explores how interpretations of the Bible can reinforce harmful ideologies', status: 'proposed' },
	...
	{ canonical: 'Jacob', variations: ['Jacob\'s', 'Jacobites'], category: 'character', description: 'Patriarch in Genesis, son of Isaac, father of the twelve tribes of Israel; his name is later changed to Israel', status: 'proposed', addedInEpisode: 63 },
	{ canonical: 'Esau', variations: ['Esau\'s'], category: 'character', description: 'Jacob\'s twin brother, son of Isaac, known for selling his birthright', status: 'proposed', addedInEpisode: 63 },
	...
	{ canonical: 'Michael Kok', variations: [], category: 'person', description: 'New Testament lecturer at Morling College, Perth Campus, specializing in gospel authorship.', status: 'proposed', addedInEpisode: 65 },
	...
	{ canonical: 'Justin Martyr', variations: ['Justin'], category: 'person', description: 'An early Christian apologist and philosopher, known for his writings defending Christianity', status: 'proposed', addedInEpisode: 65 },
	{ canonical: 'Didache', variations: ['The Didache'], category: 'literature', description: 'An early Christian treatise containing instructions for Christian communities', status: 'proposed', addedInEpisode: 65 },
	{ canonical: 'Eusebius', variations: [], category: 'person', description: 'A fourth-century church historian, known for his work on the history of the early church', status: 'proposed', addedInEpisode: 65 },
	{ canonical: 'Ignatius', variations: [], category: 'person', description: 'An early second-century bishop of Antioch, known for his letters to various Christian communities', status: 'proposed', addedInEpisode: 65 },
	{ canonical: 'Theophilus', variations: [], category: 'person', description: 'The person to whom the Gospel of Luke and the Book of Acts are addressed', status: 'proposed', addedInEpisode: 65 },
	...
	{ canonical: 'jerome', variations: [], category: 'person', description: 'A fourth-century church father, best known for translating the Bible into Latin (the Vulgate)', status: 'proposed', addedInEpisode: 65 },
	...
	{ canonical: 'Endor', variations: [], category: 'place', description: 'Mentioned in the Bible as the place where Saul consulted a necromancer', status: 'proposed', addedInEpisode: 65 },
	...
	{ canonical: 'Louisiana', variations: [], category: 'place', description: 'A state in the United States, relevant in the context of legislation regarding the Ten Commandments in public schools', status: 'proposed', addedInEpisode: 66 },
	...
	{ canonical: 'Texas', variations: [], category: 'place', description: 'A state in the United States, mentioned in relation to legal battles over the display of the Ten Commandments', status: 'proposed', addedInEpisode: 66 },
	{ canonical: 'Supreme Court', variations: [], category: 'event', description: 'The highest federal court in the United States, relevant to the legal challenges regarding the Ten Commandments', status: 'proposed', addedInEpisode: 66 },
	...
	{ canonical: 'Bathsheba', variations: [], category: 'character', description: 'Wife of Uriah the Hittite, later one of David\'s wives; their affair and its consequences are described in 2 Samuel 11-12', status: 'proposed', addedInEpisode: 67 },
	{ canonical: 'Absalom', variations: [], category: 'character', description: 'David\'s son who led a rebellion against him; his story is told in 2 Samuel 13-19', status: 'proposed', addedInEpisode: 67 },
	...
	{ canonical: 'Wil Gafney', variations: [], category: 'person', description: 'Biblical scholar and author, known for her work on womanist hermeneutics and interpretation', status: 'proposed', addedInEpisode: 67 },
	{ canonical: 'Jonathan', variations: [], category: 'character', description: 'Saul\'s son and David\'s close friend; their relationship is a prominent theme in 1 Samuel', status: 'proposed', addedInEpisode: 67 },
	{ canonical: 'Tamar', variations: [], category: 'character', description: 'Daughter-in-law of Judah, who disguised herself as a prostitute and tricked Judah into fulfilling his levirate duty, from Genesis 38', status: 'proposed', addedInEpisode: 68 },
	{ canonical: 'Onan', variations: [], category: 'character', description: 'Son of Judah who spilled his semen on the ground to avoid impregnating his brother\'s widow Tamar, from Genesis 38', status: 'proposed', addedInEpisode: 68 },
	...
	{ canonical: 'Er', variations: [], category: 'character', description: 'Eldest son of Judah, who was killed by God for being wicked', status: 'proposed', addedInEpisode: 68 },
	...
	{ canonical: 'Ruth', variations: [], category: 'literature', description: 'Book in the Hebrew Bible that tells the story of Ruth, a Moabite woman, and her relationship with Boaz', status: 'proposed', addedInEpisode: 68 },
	{ canonical: 'Boaz', variations: [], category: 'character', description: 'Kinsman of Ruth\'s deceased husband who marries her and continues the family line; story told in the Book of Ruth', status: 'proposed', addedInEpisode: 68 },
