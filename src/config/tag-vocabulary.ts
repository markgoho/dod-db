...
export const tagVocabulary: TagDefinition[] = [
  ...
  },
  {
	...
	},
	{
		...
		variations: [],
		category: 'theology',
		description: 'A ceremonial act or sequence of actions performed in a prescribed order, often having symbolic meaning within a religious or cultural context.',
		status: 'proposed',
		addedInEpisode: 162,
	},
	{
		...
		variations: [],
		category: 'theology',
		description: 'A practice involving techniques such as focusing the mind on a particular object, thought, or activity to achieve a mentally clear and emotionally calm and stable state.',
		status: 'proposed',
		addedInEpisode: 162,
	},
	{
		...
		variations: [],
		category: 'religion',
		description: 'A non-denominational religious organization that offers legal ordinations over the internet, known for its inclusive stance and allowing members to perform marriages.',
		status: 'proposed',
		addedInEpisode: 162,
	},
	{
		...
		variations: [],
		category: 'theology',
		description: 'Refers to the divine or supernatural elements of a religious ritual or belief system, especially when being distinguished from its psychological or communal aspects.',
		status: 'proposed',
		addedInEpisode: 162,
	},
	{
		...
		category: 'event',
		description: 'A Mexican holiday celebrated on November 1 and 2, where families honor and remember deceased loved ones, often by creating altars (ofrendas) with their favorite foods and belongings.',
		status: 'proposed',
		addedInEpisode: 162,
	},
	{
		...
		variations: [],
		category: 'miscellaneous',
		description: 'An altar or offering made during Dia de los Muertos to honor and welcome the spirits of deceased loved ones, typically adorned with photos, favorite foods, and marigolds.',
		status: 'proposed',
		addedInEpisode: 162,
	},
	{
		...
		variations: [],
		category: 'theology',
		description: 'A purification practice involving burning sacred herbs, typically dried sage, to cleanse a space, person, or object of negative energy or to invite positive influences.',
		status: 'proposed',
		addedInEpisode: 162,
	},
	{
		...
		variations: [],
		category: 'miscellaneous',
		description: 'A professional trained to provide psychological therapy and counseling to individuals to help them overcome mental health challenges or improve their well-being.',
		status: 'proposed',
		addedInEpisode: 162,
	},
	{
		...
		variations: [],
		category: 'theology',
		description: 'An ancient Near Eastern goddess, likely Astarte or Ishtar, worshipped by some Israelites through domestic practices and condemned in the Book of Jeremiah.',
		status: 'proposed',
		addedInEpisode: 163,
	},
	{
		...
		category: 'place',
		description: 'An 8th-century BCE site in the Sinai desert where inscriptions featuring blessings "by Yahweh and his Asherah" were found, providing evidence for Asherah worship.',
		status: 'proposed',
		addedInEpisode: 163,
	},
	{
		...
		variations: ['Ackerman'],
		category: 'person',
		description: 'A contemporary scholar known for her work on ancient Israelite religion, particularly the worship of goddesses and the roles of women.',
		status: 'proposed',
		addedInEpisode: 163,
	},
	{
		...
		category: 'character',
		description: 'A prominent West Semitic goddess of fertility, sexuality, and war, often identified with Ishtar and worshipped in ancient Israel and Judah.',
		status: 'proposed',
		addedInEpisode: 163,
	},
	{
		...
		variations: [],
		category: 'miscellaneous',
		description: 'An American conservative Christian organization founded by David Barton, known for promoting the belief that the United States was founded as a Christian nation.',
		status: 'proposed',
		addedInEpisode: 163,
	},
	{
		...
		variations: ['Lutz'],
		category: 'person',
		description: 'A political science scholar known for his research on the influence of European writers on late 18th-century American political thought.',
		status: 'proposed',
		addedInEpisode: 163,
	},
	{
		...
		variations: [],
		category: 'event',
		description: 'A gathering in 1787 in Philadelphia where the U.S. Constitution was drafted.',
		status: 'proposed',
		addedInEpisode: 163,
	},
	{
		...
		variations: [],
		category: 'people',
		description: 'A political faction in early U.S. history who supported the ratification of the U.S. Constitution and a strong federal government.',
		status: 'proposed',
		addedInEpisode: 163,
	},
	{
		...
		variations: [],
		category: 'people',
		description: 'A political faction in early U.S. history who opposed the ratification of the U.S. Constitution, arguing it granted too much power to the federal government.',
		status: 'proposed',
		addedInEpisode: 163,
	},
];
