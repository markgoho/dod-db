...
> = {
  ...
  "ex-eventu": [/ex eventu/i, /welcome to.*ex eventu/i, /segment.*ex eventu/i],
  advertisement: [
...
export const SEGMENT_DESCRIPTIONS: Record<SegmentType, string> = {
  ...
  "chapter-and-verse":
    "Reading and discussing specific Bible passages in depth",
  "conspiracy-watch":
    "Examining and debunking conspiracy theories related to religion",
  "could-it-be-satan":
  ...
  "ex-eventu":
    "Discussing prophecy written after the fact (prophecy after the event)",
  "getting-angelic":
  ...
  "is-it-canon":
    "Discussing what texts are included in biblical canons and why",
  "its-the-law": "Examining biblical laws, commandments, and legal codes",
  "know-your-bible":
    "Educational segment about biblical books, structure, and content",
  "left-behind":
    "Discussing rapture theology, end times beliefs, and the Left Behind cultural phenomenon",
  "magical-thinking":
    "Examining magical practices, supernatural beliefs, and ritualistic thinking in biblical and religious contexts",
  "main-content": "Primary discussion topic of the episode",
  "mcclellan-911": "Listener questions answered by Dan McClellan",
  "nature-of-god":
    "Theological discussion about the nature and attributes of God",
  "opportunities-for-growth":
  ...
  "your-patriarchy-and-you":
    "Examining patriarchy and gender dynamics in biblical texts",
